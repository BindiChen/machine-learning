...
[Machine Learning Model Regularization in practice: an example with Keras and TensorFlow 2.0](https://medium.com/@bindiatwork/machine-learning-model-regularization-in-practice-an-example-with-keras-and-tensorflow-2-0-52a96746123e) | [notebook](tensorflow2/003-model-regularization/model-regularization.ipynb)